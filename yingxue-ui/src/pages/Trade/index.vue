  ...
  <div class="trade-container">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{ userDefaultDddress.fullAddress }}</span>
        收货人：<span>{{ userDefaultDddress.consignee }}</span>
        <span>{{ userDefaultDddress.phoneNum }}</span>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let data = {
        consignee: this.userDefaultDddress.consignee,
        consigneeTel: this.userDefaultDddress.phoneNum,
        deliveryAddress: this.userDefaultDddress.fullAddress,
        paymentWay: "ONLINE",
        orderComment: this.msg,
        orderDetailList:this.orderInfo.detailArrayList,
      };
      let result=await this.$API.redSubmitOrder(tradeNo,data);
      if(result.code==200){
